% This file (sw2ajour.tex) contains commands for adapting SW3.x syntax to the
% syntax in the Academic Press Journal Style A (ajour.cls) Document Class

% Filename: sw2ajour.tex
% Usage:    \input{sw2ajour.tex} BEFORE \input{tcilatex} in document preamble
