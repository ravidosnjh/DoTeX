% This file (sw2cjour.tex) contains commands for adapting SW3.x syntax to the
% syntax in the Academic Press Journal Style C (cjour.cls) Document Class

% Filename: sw2cjour.tex
% Usage:    \input{sw2cjour.tex} BEFORE \input{tcilatex} in document preamble
